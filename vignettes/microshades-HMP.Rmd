...
cdf_new_smample_order <-new_sample_order_v1v3_stool$color_df

plot_2 <- plot_microshades(mdf_new_smample_order, cdf_new_smample_order)
...
cdf_new_group_order <-new_group_order_v1v3_stool$color_df

plot_3 <- plot_microshades(mdf_new_group_order, cdf_new_group_order)
...
cdf_reordered <-reordered_v1v3_stool$color_df

plot_3 <- plot_microshades(mdf_reordered, cdf_reordered)
