...
Learn more about the HMP2 Data [here](https://github.com/jstansfield0/HMP2Data)
Secondary link https://bioconductor.org/packages/release/data/experiment/html/HMP2Data.html
...
color_objs_momspi16S <- create_color_dfs(mdf_prep)

# Extract
mdf_momspi16S_unordered <- color_objs_momspi16S$mdf
cdf_momspi16S <- color_objs_momspi16S$color_df
```
...
# The default subgroup_level is "Genus" and the default specified subgroup taxonomy to order by is "Lactobacillus"
mdf_momspi16S_ordered <- reorder_samples_by(mdf_momspi16S_unordered)
plot_2 <- plot_microshades(mdf_momspi16S_ordered, cdf_momspi16S)
